...
const PostForm = ({ handleSubmit, handleChange, handleFileChange, community, clearImageInput, title, text, img }) => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            <div className="card-content">
                    ...
                    <br />
                    <div className="dropdown-comunities-container">
                        <label>Add post to community</label>
                        <select className="dropdown-community" value={community} onChange={handleChange}>
