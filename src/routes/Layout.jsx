...
const Layout = () => {
    ...
    const nickname = JSON.parse(localStorage.getItem(`account_info`))?.nickname 
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!existingUser) {
                        ...
                        localStorage.setItem('account_info', JSON.stringify(newUser));
                    } else {
            ...
            <ul>
                ...
                {!isSignedIn ? (
                    ...
                    <li className="dropdown link" style={{ marginLeft: "1.5em"}} >
                       ...
                       <Link to={`/profile/${nickname ?? 'defaultId'}`}>
                        ...
                        <ul className="dropdown-point">
                            ...
                            <hr />
                            <li><Link to={`/profile/${nickname ?? 'defaultId'}`}><span className="dropdown-link">Profile</span></Link></li>
                        </ul>
